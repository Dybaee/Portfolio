          ...
          <div className="container">
            <section className="about-hero-page reveal-on-scroll">
              <div className="about-hero-content">
                ...
                <div className="about-buttons"><a className="btn btn-primary" href="CV Thomas Dani Artha.pdf" target="_blank" rel="noopener noreferrer"><Download size={17} /> Download CV</a><button className="btn btn-secondary" onClick={() => goToSection(3)}><Send size={17} /> Contact Me</button></div>
              </div>
